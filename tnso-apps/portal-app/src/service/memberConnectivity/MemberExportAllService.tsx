...
export class MemberExportAllService extends BaseService {
  static async getAll(
    params?: MemberConnectivityParams
  ): Promise<Response<MembersExportResponse> | undefined> {
    const urlSearchParams = encodeParams<MemberConnectivityParams>(
      params as MemberConnectivityParams
    );
