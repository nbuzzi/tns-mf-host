...
export class ErrorHelper {
  ...
  static get password(): Record<string, string> {
    return {
      ...
      passwordMinLength: i18n.t(
        TRANSLATION.ERROR.passwordMustBe12CharactersLong
      ),
      passwordComplexity: i18n.t(TRANSLATION.ERROR.thePasswordMustContain),
      passwordContainsUsername: i18n.t(
        TRANSLATION.ERROR.passwordCannotContainUsername
      ),
      badResetPasswordToken: i18n.t(
        TRANSLATION.ERROR.resetPasswordTokenInvalid
      ),
    };
  }
}
